'''
Script to convert PDF to plain text using pdfminer. Adapted from Linh Huang notebook - https://github.com/infoqualitylab/DDI_Evidence_Classification/blob/b515b659ac7ad0c695dee9e36d63c9ed5777b7ed/Scripts/Preprocess_fulltext_papers.ipynb.
Not an independent script - used by machineReadMain.py
